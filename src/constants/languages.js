export const LANGUAGES_DATA = [
  // Data dưới là do Unity define ra
...
export const LANGUAGES = LanguageCode.map((el) => {
  const activedLang = LANGUAGES_DATA.find((data) => data.code === el);
  return activedLang || { code: el, name: el };
});
